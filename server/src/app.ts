...
import { sophiePreferenceRoutes } from "./routes/sophie-preferences.js";
import { designExtractRoutes } from "./routes/design-extract.js";
...
export async function createApp(
  ...
  api.use(sophiePreferenceRoutes(db));
  api.use(designExtractRoutes());
